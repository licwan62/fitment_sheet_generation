...
## 文件位置
- 自动化脚本：`D:\Home\Scripts\fitment_sheet_generation\simple_automation.ps1`
- 启动脚本：`D:\Home\Scripts\fitment_sheet_generation\run_automation.bat`
...
```powershell
python .\fitment_sheet_generation\merge_final_round_results.py
```
