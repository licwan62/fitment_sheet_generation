...
* 将 S10 `2001-2003` 的空白占位行全部替换为逐年实际组合，补齐普通版 Regular、Extended、Crew 的 CAB、BED、长宽高和参考车型。GM Heritage Archive 提供这三个年度的官方 S-10 Vehicle Information Kit。([通用汽车][1])
* 2001 年确认 Regular Cab 仅提供 2WD：短货斗为 `190.1 × 67.9 × 62.0 in`，长货斗为 `206.1 × 67.9 × 62.9 in`；删除原先错误预留的 Regular 4WD 两行。
* 2002 年确认普通阵容只有 Regular 2WD 6.0、Extended 2WD 6.0、Extended 4WD 6.0、Crew 4WD 4.5；当年 Regular 2WD 长货斗已取消，因此删除 2002 Regular 7.5 及所有 Regular 4WD 组合。([雪佛兰新闻中心][2])
* 2002 年 Extended 2WD 使用 `206.1 × 67.9 × 62.7 in`，Extended 4WD 使用 `204.8 × 67.9 × 63.4 in`；两者轴距和长度不同，未强行合并。
* 2003 年 Regular 2WD 长货斗重新出现在官方配置中；补入 Regular 6.0、Regular 7.5、Extended 2WD、Extended 4WD 和 Crew 4WD，仍无普通 Regular 4WD。([Edmunds][3])
* 将原 `2001-2004 Crew 4.5` 聚合行拆开：2001、2002-2003 按官方年度尺寸填写，2004 单独保留。2003 Crew 的官方尺寸为 `204.8 × 67.8 × 63.4 in`，Edmunds 则列为 `205.3 × 67.9 × 63.4 in`，已在状态中保留具体来源冲突。([Edmunds][4])
...
Chevrolet	S10	gen2	2001	Pickup	4WD	皮卡	Extended	6.0	204.8	67.9	63.4	2001 Chevrolet S-10 Extended Cab 4WD 6.0-ft Bed	72.8-in短货斗；基础4WD，不含ZR2宽轮眉	待终核: 2001 ZR2宽度和高度尚未补齐
...
Chevrolet	S10	gen2	2002	Pickup	4WD	皮卡	Extended	6.0	204.8	67.9	63.4	2002 Chevrolet S-10 Extended Cab 4WD 6.0-ft Bed	72.8-in短货斗；122.9-in轴距；基础4WD	待终核: 2002 ZR2宽度和高度尚未补齐
...
Chevrolet	S10	gen2	2003	Pickup	4WD	皮卡	Extended	6.0	204.8	67.9	63.4	2003 Chevrolet S-10 Extended Cab 4WD 6.0-ft Bed	72.8-in短货斗；基础4WD，不含ZR2宽轮眉	待终核: 2003 ZR2宽度和高度尚未补齐
...
1. **下一步优先补缺失：**拆分并补齐 S10 ZR2 的真实销售年份、Regular/Extended CAB、6.0 BED、L-IN、宽体 W-IN 和加高 H-IN。
2. 核对 S10 Xtreme/ZQ8 在 1999-2003 是否因空气动力套件和降低悬架形成独立长度或高度，存在差异则补行。
3. 补齐 Astro 1985-1989 的短轴三维和逐年参考车型。
4. 解决 Lumina APV 1993 的 L-IN、H-IN 和参考车型空值。
5. 按轴距及短轴/长轴车身拆分 Chevy Van 1965-1996，并优先补 without-mirrors 宽度。
6. 补齐 El Camino 1959-1977、1979-1986 的 BED、三维和参考车型。

下一步

继续优先补齐 S10 ZR2 的逐年 CAB、BED、宽体宽度、加高高度和参考车型。

[1]: https://www.gm.com/heritage/archive/vehicle-information-kits "GM Heritage Archive: Vehicle Info Kits | General Motors"
[2]: https://news.chevrolet.com/content/dam/company/no_search/heritage-archive-docs/vehicle-information-kits/chevrolet/2002-Chevrolet-S-10.pdf?utm_source=chatgpt.com "ChevroletS-102002"
[3]: https://www.edmunds.com/chevrolet/s-10/2003/regular-cab/features-specs/ "Used 2003 Chevrolet S-10 Regular Cab Specs & Features | Edmunds"
[4]: https://www.edmunds.com/chevrolet/s-10/2003/crew-cab/features-specs/ "Used 2003 Chevrolet S-10 Crew Cab Specs & Features | Edmunds"
